...
public class Ex2 {
    ...
    public static void main(String[] args) {
        ...
        while (quit) {
            ...
            if (playerMove.equals("q")) {
                ...
                if (computerMove.equals(sps.PAPER.key)) {
                ...
                if (computerMove.equals(sps.SCISSORS.key)) {
                    System.out.println("Scissors cuts paper, I won!");
                } else {
                    System.out.println("You won!");
                }
            } else {
                if (computerMove.equals(sps.STONE.key)) {
                    System.out.println("Stone breaks scissors");
                } else {
                    System.out.println("You won!");
                }
            }
    ...
    public static String getComputerMove() {
        ...
        Sps sps = Sps.PAPER.getRandomValue();

        System.out.println("My turn: " + sps);
        return sps.key;
    }
